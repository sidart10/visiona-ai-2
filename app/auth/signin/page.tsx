...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-black p-4">
      ...
      {/* Sign-in card */}
      <Card className="w-full max-w-md bg-black border-[#333]/50 shadow-xl text-white relative z-10">
        <CardContent className="p-6">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-black px-2 text-gray-400 uppercase">OR</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-left">
            ...
            <div className="space-y-1">
              <div className="flex justify-between items-center">
                ...
                <Link href="/auth/forgot-password" className="text-xs text-[#1eb8cd] hover:text-[#7fdce8]">
                  Forgot password?
                </Link>
              </div>
              <Input
          ...
          <div className="text-center text-sm mt-6">
            <p className="text-gray-400">
              ...
              <Link href="/auth/signup" className="text-[#1eb8cd] hover:text-[#7fdce8]">
                Sign up
              </Link>
            </p>
          </div>
